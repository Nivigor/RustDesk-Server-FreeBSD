# RustDesk-Server-FreeBSD
 Install your own [open source RustDesk Server](https://github.com/rustdesk/rustdesk-server) on FreeBSD or XigmaNAS: 
 1. Create a folder for server and go to it.
